...
public class Service {
    ...
    ServiceCallResult call(String methodName, Object[] parameters) throws ServiceException {
        ...
        if (!hasMethodWithSameName) {
            throw new WrongServiceMethodException("Method " + methodName + " not found");
        }
        try {
            ...
            throw new WrongServiceMethodException("Method " + methodName + " with such signature not found");
